          ...
          <div className="footer__links">
            ...
            <div className="footer__column">
              ...
              <div className="footer__social">
                <a href="https://www.instagram.com/devabordo" className="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                ...
                <a href="https://www.linkedin.com/school/devclub-com-br" className="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                <a href="https://www.youtube.com/@DevClub-RodolfoMori" className="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                <a href="https://discord.gg/devclub" className="footer__social-link" target="_blank" rel="noopener noreferrer" aria-label="Discord">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                <a href="https://go.rodolfomori.com.br/suporte" className="footer__social-link footer__social-link--green" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
